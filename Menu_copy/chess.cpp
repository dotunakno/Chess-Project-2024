...
int main()
{
    ...
    Button newButton("", pieceSize * 8, 0);
    ...
    while (window.isOpen())
    {
        ...
        newX = std::min<float>(7, Mouse::getPosition(window).x / pieceSize);
        newY = std::min<float>(7, Mouse::getPosition(window).y / pieceSize);
        ...
        if (gameMode)
        {
            ...
            boxx.setFillColor(Color::Red);
        }
        else boxx.setFillColor(Color::Blue);
